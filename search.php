<?php get_header(); ?>
			...
			<div id="content" class="clearfix row">
				...
				<div id="main" class="col col-lg-8 clearfix container-fluid search" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<header>
							...
							<p class="metasearch"><?php _e("Posted", "wpbootstrap"); ?> <time datetime="<?php echo the_time('d/m/Y'); ?>" pubdate><?php the_time('d/m/Y'); ?></time> <?php _e("by", "wpbootstrap"); ?> <?php the_author_posts_link(); ?></p>
